...
const LeftIconGridCard: React.FC<LeftIconGridCardProps> = ({ data }) => {
	return (
		<div className="tw:!container tw:!mx-auto tw:!py-16 tw:!text-center">
			<div className="tw:!flex tw:!flex-wrap tw:!justify-center tw:!gap-6">
				{data.map((feature, index) => (
					<div
						key={index}
						className="tw:!bg-white tw:!shadow-lg tw:!py-8 tw:!px-6 tw:!rounded-3xl tw:!text-left tw:!flex tw:!items-center tw:!gap-6 tw:!transition-all tw:!duration-300 hover:tw:!shadow-2xl hover:tw:!scale-105 tw:!basis-full sm:tw:!basis-[45%] md:tw:!basis-[30%] tw:!max-w-[480px]"
					>
