					...
					<section className="section-box-banner-3 banner-2 background-body">
						<div className="container pt-110 pb-110 position-relative z-1">
							<div className="row justify-content-center">
								<div className="col-auto text-center wow  justify-content-center d-flex flex-column align-items-center">
					...
					<section className="section-box box-news background-body">
						<div className="container">
							<div className="row align-items-end">
								...
								<div className="col-md-3 position-relative mb-30 wow ">
									<div className="box-button-slider box-button-slider-team justify-content-end">
										<div
											className="swiper-button-prev swiper-button-prev-style-1 swiper-button-prev-2"
											tabIndex={0}
							...
							<div className="box-list-news wow  mt-5">
								<div className="box-swiper">
									<Swiper
										{...swiperGroup3}
