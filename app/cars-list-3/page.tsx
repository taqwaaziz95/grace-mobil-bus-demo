						...
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img
									...
									src={withBasePath("/assets/imgs/page-header/banner6.png")}
									alt="Gracetrans"
								/>
							</div>
											...
											<div className="block-filter border-1">
												...
												<div className="d-flex justify-content-between pt-20 border-top">
													...
													<Link href="#" className="btn btn-primary px-3 py-2">
														<img
															src={withBasePath(
																"/assets/imgs/template/icons/user.svg"
															)}
															alt="Gracetrans"
														/>
														Apply
														...
														<li>
															<label className="cb-container">
																...
																<span className="text-sm-medium">
																	...
																	<img
																		src={withBasePath(
																			"/assets/imgs/template/icons/star-yellow.svg"
																		)}
																		alt="Gracetrans"
																	/>
																	<img
										...
										<li className="carouselTicker__item">
											<div className="item-brand">
												<img
													...
													src={withBasePath(
														"/assets/imgs/page/homepage2/lexus.png"
													)}
													alt="Gracetransx"
												/>
												<img
													className="dark-mode"
													src={withBasePath(
														"/assets/imgs/page/homepage2/lexus-w.png"
													)}
													alt="Gracetrans"
												/>
											</div>
