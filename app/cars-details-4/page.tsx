							...
							<div className="container-banner-activities">
								<div className="box-banner-activities">
									<Slider {...settings}  className="banner-activities-detail">
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner.png" alt="Gracetrans" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner2.png" alt="Gracetrans" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner3.png" alt="Gracetrans" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner4.png" alt="Gracetrans" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner5.png" alt="Gracetrans" /></div>
									</Slider>
									<div className="box-button-abs">
										...
										<a className="btn btn-white-md popup-youtube" onClick={() => setOpen(true)}> <img src="/assets/imgs/page/activities/video.svg" alt="Gracetrans" />Video Clips</a>
									</div>
								</div>
							</div>
						</div>
